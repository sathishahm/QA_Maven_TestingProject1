...
public class Demo {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		System.out.println(driver.findElement(By.xpath("//ul[@class='breadcrumb']//a[contains(text(),'Account')]")).isEnabled()); //true
		...
		System.out.println(driver.findElement(By.xpath("//div[@class='caption']//a[contains(text(),'iPhone')]")).isDisplayed());  //true
		...
		Thread.sleep(5000);
		System.out.println(driver.findElement(By.xpath("//div[@class='alert alert-success alert-dismissible']")).getText().contains("Success: You have added iPhone to your shopping cart!"));
		...
		System.out.println(driver.findElement(By.xpath("//*[@id=\"content\"]/h1")).getText().contains("Your order has been placed!"));
		System.out.println(driver.findElement(By.xpath("//*[@id=\"common-success\"]/ul/li[4]/a")).isDisplayed());
		System.out.println(driver.findElement(By.xpath("//*[@id=\"common-success\"]/ul/li[4]/a")).getText().contains("Success"));
